...
<?php $__env->startSection('title', 'Edit Round'); ?>

<?php $__env->startSection('content'); ?>
    <div class="mb-8">
        <h1 class="text-2xl font-bold text-black">Edit Round</h1>
        <p class="text-black">Update round information and motion</p>
    </div>

    <div class="bg-white overflow-hidden rounded-xl shadow-sm ring-1 ring-slate-200 p-6">
        <form action="<?php echo e(route('admin.rounds.update', $round)); ?>" method="POST">
            <?php echo csrf_field(); ?>
                    ...
                    <select id="tournament_id" name="tournament_id" required
                        ...
                        <?php $__currentLoopData = $tournaments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tournament): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($tournament->id); ?>"
                                <?php echo e($round->tournament_id == $tournament->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" value="<?php echo e(old('name', $round->name)); ?>" required
                        class="mt-1 block w-full rounded-md border-slate-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" name="round_number" id="round_number"
                        value="<?php echo e(old('round_number', $round->round_number)); ?>" required min="1"
                        class="mt-1 block w-full rounded-md border-slate-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea name="motion" id="motion" rows="3"
                        class="mt-1 block w-full rounded-md border-slate-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"><?php echo e(old('motion', $round->motion)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea name="info_slide" id="info_slide" rows="4"
                        class="mt-1 block w-full rounded-md border-slate-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"><?php echo e(old('info_slide', $round->info_slide)); ?></textarea>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\EDS-TABULATION\resources\views\admin\rounds\edit.blade.php ENDPATH**/ ?>