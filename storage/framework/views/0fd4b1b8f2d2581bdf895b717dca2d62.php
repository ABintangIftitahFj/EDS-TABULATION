    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            <h1 class="text-5xl font-pixel leading-tight text-england-blue drop-shadow-sm">
                💡 MOTIONS: <?php echo e($tournament->name); ?>
        ...
        <div class="border-b-4 border-slate-200 mb-8 overflow-x-auto pb-1">
            <nav class="-mb-1 flex space-x-8 min-w-max" aria-label="Tabs">
                ...
                <a href="/tournaments/<?php echo e($tournament->id); ?>/motions" class="pixel-tab pixel-tab-active">
                    💡 MOTIONS
                </a>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $tournament->rounds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $round): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="pixel-card overflow-hidden bg-white hover:shadow-pixel-lg transition-all duration-300">
                    <div class="px-6 py-4 border-b-4 border-slate-900 bg-england-blue flex justify-between items-center">
                        <h3 class="text-2xl font-pixel text-white"><?php echo e($round->name); ?></h3>
                        <span
                        ...
                        <?php if($round->info_slide): ?>
                            <div
                                ...
                                <span
                                    ...
                                    SLIDE</span>
                                <p class="text-base font-sans text-black leading-relaxed"><?php echo e($round->info_slide); ?></p>
                            </div>
                        <?php endif; ?>
                        
                        <!-- See Draw Button -->
                        <div class="mt-8">
                            <a href="/tournaments/<?php echo e($tournament->id); ?>/matches?round=<?php echo e($round->id); ?>" 
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\EDS-TABULATION\resources\views/tournaments/motions.blade.php ENDPATH**/ ?>