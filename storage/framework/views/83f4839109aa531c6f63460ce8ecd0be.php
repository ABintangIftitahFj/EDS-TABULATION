...
<div id="adjudicator-modal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden flex items-center justify-center">
    <div class="bg-white rounded-xl shadow-xl max-w-md w-full mx-4">
        <div class="p-6">
            ...
            <form id="adjudicator-form" action="<?php echo e(route('admin.adjudicators.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
</div><?php /**PATH C:\laragon\www\EDS-TABULATION\resources\views\admin\tournaments\modals\adjudicator-modal.blade.php ENDPATH**/ ?>