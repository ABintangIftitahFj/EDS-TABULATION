...
<?php $__env->startSection('title', 'Create Adjudicator'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="bg-white overflow-hidden rounded-xl shadow-sm ring-1 ring-slate-200 p-6">
        <form action="<?php echo e(route('admin.adjudicators.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <select id="tournament_id" name="tournament_id" required
                        ...
                        <?php $__currentLoopData = $tournaments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tournament): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($tournament->id); ?>" <?php echo e((old('tournament_id') ?? request('tournament_id')) == $tournament->id ? 'selected' : ''); ?>><?php echo e($tournament->name); ?></option>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="institution" id="institution" value="<?php echo e(old('institution')); ?>"
                        class="mt-1 block w-full rounded-md border-slate-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" name="rating" id="rating" value="<?php echo e(old('rating')); ?>" min="0" max="10" step="0.1"
                        class="mt-1 block w-full rounded-md border-slate-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\EDS-TABULATION\resources\views\admin\adjudicators\create.blade.php ENDPATH**/ ?>