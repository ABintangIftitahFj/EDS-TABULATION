...
<?php $__env->startSection('content'); ?>
        ...
        <div
            ...
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-3xl font-bold font-sans text-black"><?php echo e($stats['total_tournaments']); ?></p>
                </div>
            </div>
        </div>
        <div
            ...
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-3xl font-bold font-sans text-black"><?php echo e($stats['total_teams']); ?></p>
                </div>
            </div>
        </div>
        <div
            ...
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-3xl font-bold font-sans text-black"><?php echo e($stats['total_adjudicators']); ?></p>
                </div>
            </div>
        </div>
        <div
            ...
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-3xl font-bold font-sans text-black"><?php echo e($stats['active_tournament'] ? 'Yes' : 'No'); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl border-2 border-black shadow-pixel overflow-hidden mb-8">
        ...
        <div class="p-6 overflow-x-auto">
            <?php if($stats['active_tournament']): ?>
                <div class="flex gap-6 pb-4 min-w-max md:min-w-0 md:grid md:grid-cols-1 md:gap-4">
                    <?php $__currentLoopData = \App\Models\Tournament::where('status', 'ongoing')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tournament): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div
                            ...
                            <div class="flex items-center gap-4 mb-4 md:mb-0">
                                ...
                                <div>
                                    <h4 class="text-xl font-bold font-sans text-black"><?php echo e($tournament->name); ?></h4>
                                    <p class="text-sm font-mono text-slate-600">
                                        <?php echo e(ucfirst(str_replace('_', ' ', $tournament->format))); ?> •
                                        <?php echo e($tournament->start_date ? $tournament->start_date->format('M d, Y') : 'Date TBA'); ?>

                                    </p>
                                    <p class="text-sm font-mono text-slate-600">📍 <?php echo e($tournament->location); ?></p>
                                </div>
                            </div>
        ...
        <div class="overflow-x-auto">
            <div class="overflow-x-auto" style="-webkit-overflow-scrolling: touch;">
                ...
                <tbody class="bg-white divide-y divide-slate-200">
                    <?php $__empty_1 = true; $__currentLoopData = \App\Models\Tournament::orderBy('created_at', 'desc')->take(10)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tournament): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-blue-50 transition-colors">
                            <td class="px-6 py-4 whitespace-nowrap border-r border-slate-100">
                                <div class="text-base font-bold font-sans text-black"><?php echo e($tournament->name); ?></div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap border-r border-slate-100">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\EDS-TABULATION\resources\views\admin\dashboard.blade.php ENDPATH**/ ?>