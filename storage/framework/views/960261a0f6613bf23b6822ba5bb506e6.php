...
<?php endif; ?>
        ...
        <div class="flex items-center justify-end mt-4">
            <a class="underline text-sm text-black hover:text-black rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="<?php echo e(route('login')); ?>">
...
<?php /**PATH C:\laragon\www\EDS-TABULATION\resources\views\auth\register.blade.php ENDPATH**/ ?>