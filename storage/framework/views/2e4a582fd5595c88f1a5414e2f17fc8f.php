...
<?php endif; ?>
    ...
    <div class="pt-4 pb-1 border-t border-gray-200">
        <div class="px-4">
            <div class="font-medium text-base text-black"><?php echo e(Auth::user()->name ?? 'Guest'); ?></div>
            <div class="font-medium text-sm text-black"><?php echo e(Auth::user()->email ?? ''); ?></div>
        </div>
...
<?php /**PATH C:\laragon\www\EDS-TABULATION\resources\views\layouts\navigation.blade.php ENDPATH**/ ?>