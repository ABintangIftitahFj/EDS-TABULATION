    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="min-w-0 flex-1">
                <div class="flex items-center gap-2 mb-2">
                    <span
                        ...
                        <?php echo e($tournament->format ?? 'AP'); ?>

                    </span>
                    <span
                        class="text-lg font-pixel text-slate-600 bg-white px-2 border-2 border-slate-300"><?php echo e($tournament->year ?? date('Y')); ?></span>
                ...
                <h1 class="text-5xl font-pixel leading-tight text-england-blue drop-shadow-sm mt-2">
                    🏆 <?php echo e($tournament->name ?? 'Tournament Name'); ?>
        ...
        <div class="border-b-4 border-slate-200 mb-8 overflow-x-auto pb-1">
            <nav class="-mb-1 flex space-x-8 min-w-max" aria-label="Tabs">
                ...
                <a href="/tournaments/<?php echo e($tournament->id ?? 1); ?>" class="pixel-tab pixel-tab-active">
                    🏠 OVERVIEW
                </a>
                <a href="/tournaments/<?php echo e($tournament->id ?? 1); ?>/motions" class="pixel-tab text-slate-600 hover:text-black">
                    💡 MOTIONS
                </a>
                <a href="/tournaments/<?php echo e($tournament->id ?? 1); ?>/standings"
                    class="pixel-tab text-slate-600 hover:text-black">
                    🏆 STANDINGS
                </a>
                <a href="/tournaments/<?php echo e($tournament->id ?? 1); ?>/matches" class="pixel-tab text-slate-600 hover:text-black">
                    ⚔️ MATCHES & DRAW
                </a>
                <a href="/tournaments/<?php echo e($tournament->id ?? 1); ?>/results" class="pixel-tab text-slate-600 hover:text-black">
                    📊 RESULTS
                </a>
                <a href="/tournaments/<?php echo e($tournament->id ?? 1); ?>/speakers"
                    class="pixel-tab text-slate-600 hover:text-black">
                    🎤 SPEAKERS
                </a>
                <a href="/tournaments/<?php echo e($tournament->id ?? 1); ?>/adjudicators"
                    class="pixel-tab text-slate-600 hover:text-black">
                    ⚖️ ADJUDICATORS
                </a>
                <a href="/tournaments/<?php echo e($tournament->id ?? 1); ?>/participants"
                    class="pixel-tab text-slate-600 hover:text-black">
                    👥 PARTICIPANTS
                </a>
            </nav>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-8">
            ...
            <a href="<?php echo e(route('tournaments.standings', $tournament->id)); ?>"
                ...
                <div class="flex items-center relative z-10">
                    ...
                    <div class="ml-3 md:ml-4">
                        ...
                        <p class="text-2xl md:text-4xl font-pixel text-england-blue"><?php echo e($tournament->teams->count() ?? 0); ?></p>
                    </div>
                </div>
            </a>

            
            <a href="<?php echo e(route('tournaments.adjudicators', $tournament->id)); ?>"
                class="pixel-card p-4 md:p-6 bg-white relative overflow-hidden group hover:-translate-y-1 transition-transform duration-200 cursor-pointer block">
                <div class="absolute top-0 right-0 p-2 md:p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                ...
                <div class="flex items-center relative z-10">
                    ...
                    <div class="ml-3 md:ml-4">
                        ...
                        <p class="text-2xl md:text-4xl font-pixel text-purple-600"><?php echo e($tournament->adjudicators->count() ?? 0); ?></p>
                    </div>
                </div>
            </a>

            
            <a href="<?php echo e(route('tournaments.matches', $tournament->id)); ?>"
                class="pixel-card p-4 md:p-6 bg-white relative overflow-hidden group hover:-translate-y-1 transition-transform duration-200 cursor-pointer block">
                <div class="absolute top-0 right-0 p-2 md:p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                ...
                <div class="flex items-center relative z-10">
                    ...
                    <div class="ml-3 md:ml-4">
                        ...
                        <p class="text-2xl md:text-4xl font-pixel text-green-600"><?php echo e($tournament->rounds->count() ?? 0); ?></p>
                    </div>
                </div>
            </a>

            
            <a href="<?php echo e(route('tournaments.participants', $tournament->id)); ?>"
                class="pixel-card p-4 md:p-6 bg-white relative overflow-hidden group hover:-translate-y-1 transition-transform duration-200 cursor-pointer block">
                <div class="absolute top-0 right-0 p-2 md:p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                ...
                <div class="flex items-center relative z-10">
                    ...
                    <div class="ml-3 md:ml-4">
                        ...
                        <p class="text-2xl md:text-4xl font-pixel text-england-red"><?php echo e($tournament->teams->sum(fn($t) => $t->speakers->count())); ?></p>
                    </div>
                </div>
            </a>
        </div>
        ...
        <div class="grid grid-cols-1 gap-6">
            ...
            <div class="pixel-card p-6">
                ...
                <div class="prose prose-slate text-base text-slate-700 font-sans leading-relaxed">
                    <p><?php echo e($tournament->description ?? 'Welcome to the official page for this tournament. Here you can find all the latest updates, standings, and match draws.'); ?>
                        ...
                        <li class="relative flex gap-x-4 p-4 bg-yellow-50 border-2 border-yellow-200 shadow-sm rounded-none">
                            <div class="flex-auto">
                                <div class="flex items-baseline justify-between gap-x-4">
                                    <p class="text-lg font-pixel text-yellow-800">🎯 <?php echo e($latestRound->name); ?> Draw Released</p>
                                    <p class="flex-none text-xs font-bold text-yellow-600 uppercase tracking-wide">
                                        ⏰ <?php echo e($latestRound->updated_at->diffForHumans()); ?>

                                    </p>
                                </div>
                                <p class="mt-1 text-sm leading-6 text-yellow-700 font-sans">
                                    The draw for <?php echo e($latestRound->name); ?> is now live.
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\EDS-TABULATION\resources\views/tournaments/show.blade.php ENDPATH**/ ?>