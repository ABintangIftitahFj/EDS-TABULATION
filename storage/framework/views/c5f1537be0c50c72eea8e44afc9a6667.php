...
<?php $__env->startSection('title', 'Edit Match'); ?>
                ...
                <div>
                    ...
                    <select id="round_id" name="round_id" required
                        ...
                        <?php $__currentLoopData = $rounds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $round): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($round->id); ?>" data-format="<?php echo e($round->tournament->format); ?>" <?php echo e($match->round_id == $round->id ? 'selected' : ''); ?>>
                ...
                <div>
                    ...
                    <select id="room_id" name="room_id"
                        ...
                        <?php $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($room->id); ?>" <?php echo e($match->room_id == $room->id ? 'selected' : ''); ?>>
                    ...
                    <div>
                        ...
                        <select id="gov_team_id" name="gov_team_id" required
                            ...
                            <?php $__currentLoopData = $teams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($team->id); ?>" <?php echo e($match->gov_team_id == $team->id ? 'selected' : ''); ?>>
                                    <?php echo e($team->name); ?> (<?php echo e($team->institution); ?>)
                                </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select id="opp_team_id" name="opp_team_id" required
                            ...
                            <option value="">Select Team</option>
                            <?php $__currentLoopData = $teams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($team->id); ?>" <?php echo e($match->opp_team_id == $team->id ? 'selected' : ''); ?>>
                                    <?php echo e($team->name); ?> (<?php echo e($team->institution); ?>)
                                </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div id="bp_fields" class="contents <?php echo e($match->round->tournament->format === 'british' ? '' : 'hidden'); ?>">
                        <div>
                            ...
                            <select id="cg_team_id" name="cg_team_id"
                                ...
                                <option value="">Select Team</option>
                                <?php $__currentLoopData = $teams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($team->id); ?>" <?php echo e($match->cg_team_id == $team->id ? 'selected' : ''); ?>>
                                        <?php echo e($team->name); ?> (<?php echo e($team->institution); ?>)
                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select id="co_team_id" name="co_team_id"
                                ...
                                <option value="">Select Team</option>
                                <?php $__currentLoopData = $teams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($team->id); ?>" <?php echo e($match->co_team_id == $team->id ? 'selected' : ''); ?>>
                                        <?php echo e($team->name); ?> (<?php echo e($team->institution); ?>)
                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                ...
                <div>
                    ...
                    <select id="adjudicator_id" name="adjudicator_id"
                        ...
                        <?php $__currentLoopData = $adjudicators; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $adjudicator): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($adjudicator->id); ?>" <?php echo e($match->adjudicator_id == $adjudicator->id ? 'selected' : ''); ?>>
                                <?php echo e($adjudicator->name); ?> (<?php echo e($adjudicator->institution); ?>)
                            </option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\EDS-TABULATION\resources\views/admin/matches/edit.blade.php ENDPATH**/ ?>