...
<?php $__env->startSection('title', 'Match Scoring - ' . $tournament->name); ?>
            ...
            <div class="flex items-center justify-between">
                <div>
                    <div class="flex items-center gap-3 mb-2">
                        <a href="<?php echo e(route('admin.match-scoring.index')); ?>" 
                ...
                <div class="flex gap-3">
                    <a href="<?php echo e(route('admin.tournament-dashboard', $tournament)); ?>" 
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <select id="roundSelect" 
                            ...
                            <option value="<?php echo e($round->id); ?>" data-published="<?php echo e($round->is_published ? 1 : 0); ?>">
                                <?php echo e($round->name); ?>

                                <?php if($round->is_published): ?> ✅ <?php else: ?> 🔒 <?php endif; ?>
                            </option>
                ...
                <div class="space-y-6">
                    ...
                    <div class="border border-gray-200 rounded-lg p-4">
                        <div class="flex items-center justify-between mb-4">
                            <div>
                                <h3 class="text-lg font-semibold text-black"><?php echo e($round->name); ?></h3>
                                <p class="text-sm text-black"><?php echo e($round->matches_count ?? 0); ?> matches</p>
                            </div>
                            <div class="flex gap-2">
                                <!-- Draw Publication Toggle -->
                                <button onclick="toggleDrawPublication(<?php echo e($round->id); ?>, <?php echo e($round->is_published ? 'false' : 'true'); ?>)" 
                                        class="flex items-center gap-2 px-3 py-1 rounded-lg text-sm font-medium transition-colors
                                               <?php echo e($round->is_published ? 'bg-green-100 text-green-700 hover:bg-green-200' : 'bg-gray-100 text-black hover:bg-gray-200'); ?>">
                                    <?php if($round->is_published): ?>
                                        ✅ Published
                                    <?php else: ?>
                                        🔒 Unpublished
                                    <?php endif; ?>
                                ...
                                <button onclick="toggleMotionPublication(<?php echo e($round->id); ?>, <?php echo e($round->is_motion_published ? 'false' : 'true'); ?>)" 
                                        class="flex items-center gap-2 px-3 py-1 rounded-lg text-sm font-medium transition-colors
                                               <?php echo e($round->is_motion_published ? 'bg-blue-100 text-blue-700 hover:bg-blue-200' : 'bg-gray-100 text-black hover:bg-gray-200'); ?>">
                                    <?php if($round->is_motion_published): ?>
                                        💡 Motion Live
                                    <?php else: ?>
                                        🔒 Motion Hidden
                                    <?php endif; ?>
                        ...
                        <div class="mt-4 overflow-x-auto">
                            <?php if($round->matches && $round->matches->count() > 0): ?>
                                <table class="min-w-full divide-y divide-gray-200 text-sm">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-100">
                                        <?php $__currentLoopData = $round->matches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td class="px-3 py-2"><?php echo e($m->room->name ?? 'TBA'); ?></td>
                                                <td class="px-3 py-2"><?php echo e($m->govTeam->name ?? 'TBA'); ?></td>
                                                <td class="px-3 py-2"><?php echo e($m->oppTeam->name ?? 'TBA'); ?></td>
                                                <td class="px-3 py-2"><?php echo e($m->winner->name ?? '-'); ?></td>
                                            </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </tbody>
                                </table>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\EDS-TABULATION\resources\views\admin\match-scoring\show.blade.php ENDPATH**/ ?>