    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            <h1 class="text-5xl font-pixel leading-tight text-england-blue drop-shadow-sm">
                🏆 STANDINGS: <?php echo e($tournament->name); ?>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y-2 divide-slate-900">
                        ...
                        <tbody class="bg-white divide-y-2 divide-slate-100">
                            <?php $__empty_1 = true; $__currentLoopData = $tournament->teams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr
                                    class="<?php echo e($index < 3 ? 'bg-yellow-50' : 'hover:bg-soft-pink/10'); ?> transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-700 font-sans border-r border-slate-100">🏦 <?php echo e($team->institution); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap border-r border-slate-100">
                                        <span
                    ...
                    <table class="min-w-full divide-y-2 divide-slate-900">
                        ...
                        <tbody class="bg-white divide-y-2 divide-slate-100">
                            <?php $__empty_1 = true; $__currentLoopData = $speakers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $speaker): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr
                                    class="<?php echo e($loop->iteration <= 3 ? 'bg-purple-50' : 'hover:bg-soft-pink/10'); ?> transition-colors">
                                    <td class="px-6 py-4 whitespace-nowrap text-lg font-pixel border-r border-slate-100">
                                        ...
                                        <?php elseif($loop->iteration === 3): ?>
                                            <span class="text-3xl drop-shadow-sm">🥉</span>
                                        <?php else: ?>
                                            <span class="text-slate-600 font-bold">#<?php echo e($loop->iteration); ?></span>
                                        <?php endif; ?>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap border-r border-slate-100">
                                        <div class="flex items-center gap-2">
                                            <span class="text-base font-bold text-black font-sans">🎤 <?php echo e($speaker->name); ?></span>
                                            <?php if($loop->iteration === 1): ?>
                                                <span
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-700 font-sans border-r border-slate-100">
                                        <?php echo e($speaker->team->name ?? 'N/A'); ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap border-r border-slate-100">
                                        <span
                                            ...
                                            🎯 <?php echo e($speaker->total_score); ?>

                                        </span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-bold font-mono text-black">
                                        <?php echo e($speaker->average_score ?? '0.00'); ?>
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\EDS-TABULATION\resources\views/tournaments/standings.blade.php ENDPATH**/ ?>