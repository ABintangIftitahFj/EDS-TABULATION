<?php $__env->startSection('title', 'Rounds'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="mb-8 flex items-center justify-between">
        ...
        <a href="<?php echo e(route('admin.rounds.create')); ?>"
    ...
    <div class="mb-6 bg-white rounded-lg shadow-sm p-4">
        <form method="GET" action="<?php echo e(route('admin.rounds.index')); ?>" class="flex items-center gap-4">
            ...
            <?php if($tournamentFilter): ?>
                <a href="<?php echo e(route('admin.rounds.index')); ?>" class="px-3 py-2 text-sm text-gray-600 hover:text-gray-900">
                    Clear Filter
                </a>
            <?php endif; ?>
        </form>
    ...
    <div class="md:hidden space-y-4">
            ...
            <div class="bg-white rounded-xl shadow-sm ring-1 ring-slate-200 p-4">
                <div class="flex items-start justify-between mb-2">
                    <div>
                        ...
                        <div class="text-xs text-gray-500">Round <?php echo e($round->round_number); ?></div>
                    </div>
                </div>
                <div class="text-xs text-gray-500 mb-2">
                    🏆 <?php echo e($round->tournament->name ?? 'N/A'); ?>

                </div>
                <div class="bg-slate-50 rounded-lg p-3 mb-3">
                    <div class="text-xs font-medium text-gray-500 mb-1">Motion:</div>
                    <div class="text-sm text-black"><?php echo e($round->motion ?? 'Not set'); ?></div>
                </div>
                <div class="grid grid-cols-2 gap-2 mb-3">
                    <form action="<?php echo e(route('admin.rounds.toggle-results', $round->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <button type="submit"
                            class="w-full px-2 py-2 rounded-lg text-xs font-bold border <?php echo e($round->results_published ? 'bg-green-100 text-green-800 border-green-300' : 'bg-gray-100 text-gray-600 border-gray-300'); ?>">
                            <?php echo e($round->results_published ? '✅ Scores Visible' : '🔒 Scores Hidden'); ?>
                ...
                <form action="<?php echo e(route('admin.rounds.destroy', $round)); ?>" method="POST"
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <div class="bg-white rounded-xl shadow-sm ring-1 ring-slate-200 p-8 text-center">
                ...
                <a href="<?php echo e(route('admin.rounds.create')); ?>" class="text-indigo-600 hover:text-indigo-500 text-sm">Create one</a>
            </div>
        <?php endif; ?>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $rounds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $round): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-slate-50">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-black"><?php echo e($round->name); ?></div>
                                <div class="text-sm text-black">Round <?php echo e($round->round_number); ?></div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-black"><?php echo e($round->tournament->name ?? 'N/A'); ?></div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="text-sm text-black"><?php echo e($round->motion ?? 'Not set'); ?></div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <form action="<?php echo e(route('admin.rounds.toggle-results', $round->id)); ?>" method="POST" class="inline-block mr-3">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit"
                                        class="px-2 py-1 rounded text-xs font-bold border <?php echo e($round->results_published ? 'bg-green-100 text-green-800 border-green-300' : 'bg-gray-100 text-gray-600 border-gray-300'); ?>">
                                        <?php echo e($round->results_published ? 'Hide Speaker Score' : 'Show Speaker Score'); ?>

                                    </button>
                                </form>
                                <a href="<?php echo e(route('admin.rounds.edit', $round)); ?>" class="text-indigo-600 hover:text-indigo-900 mr-3">Edit</a>
                                <form action="<?php echo e(route('admin.rounds.destroy', $round)); ?>" method="POST" class="inline-block"
                                    onsubmit="return confirm('Are you sure you want to delete this round?');">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                            <td colspan="4" class="px-6 py-12 text-center text-black">
                                No rounds found. <a href="<?php echo e(route('admin.rounds.create')); ?>" class="text-indigo-600 hover:text-indigo-500">Create one</a>
                            </td>
                        </tr>
                    <?php endif; ?>
                </tbody>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\EDS-TABULATION\resources\views\admin\rounds\index.blade.php ENDPATH**/ ?>