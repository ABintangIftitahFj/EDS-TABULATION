...
<?php $__env->startSection('content'); ?>
    ...
    <div class="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div class="flex flex-col sm:flex-row gap-2">
            ...
            <a href="<?php echo e(route('admin.matches.create')); ?>"
    ...
    <div class="mb-6 bg-white p-4 rounded-lg shadow-sm border border-slate-200">
        <form action="<?php echo e(route('admin.matches.index')); ?>" method="GET" class="flex flex-col md:flex-row gap-4 items-end">
            <div class="w-full md:w-1/3">
                ...
                <select name="tournament_id" id="tournament_id"
                    ...
                    <?php $__currentLoopData = \App\Models\Tournament::orderBy('created_at', 'desc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tournament): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($tournament->id); ?>" <?php echo e(request('tournament_id') == $tournament->id ? 'selected' : ''); ?>>
            ...
            <div class="w-full md:w-1/3">
                ...
                <select name="round_id" id="round_id"
                    ...
                    <?php if(request('tournament_id')): ?>
                        <?php $__currentLoopData = \App\Models\Round::where('tournament_id', request('tournament_id'))->orderBy('created_at', 'desc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $round): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($round->id); ?>" <?php echo e(request('round_id') == $round->id ? 'selected' : ''); ?>>
                                <?php echo e($round->name); ?>

                            </option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php else: ?>
                        <?php $__currentLoopData = \App\Models\Round::orderBy('created_at', 'desc')->take(20)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $round): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($round->id); ?>" <?php echo e(request('round_id') == $round->id ? 'selected' : ''); ?>>
                                <?php echo e($round->tournament->name); ?> - <?php echo e($round->name); ?>
        ...
        <?php $__empty_1 = true; $__currentLoopData = $matches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $match): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-4">
                ...
                <div class="flex items-start justify-between mb-3">
                    <div>
                        <div class="font-semibold text-black"><?php echo e($match->round->tournament->name ?? 'N/A'); ?></div>
                        <div class="text-sm text-gray-500"><?php echo e($match->round->name ?? 'N/A'); ?></div>
                    </div>
                    <span class="px-2 py-1 text-xs font-semibold rounded-full <?php echo e(($match->result_status ?? '') === 'completed' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'); ?>">
                        <?php echo e(ucfirst($match->result_status ?? 'Scheduled')); ?>
                ...
                <div class="bg-slate-50 rounded-lg p-3 mb-3">
                    <div class="text-xs font-medium text-gray-500 mb-2">
                        📍 <?php echo e($match->room->name ?? 'Room TBA'); ?> • 👨‍⚖️ <?php echo e($match->adjudicator->name ?? 'Adj TBA'); ?>
                    ...
                    <div class="space-y-2">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="font-semibold text-black text-sm"><?php echo e($match->govTeam->emoji ?? ''); ?> <?php echo e($match->govTeam->name ?? 'N/A'); ?></span>
                        </div>
                        <div class="flex items-center justify-between">
                            <span class="text-xs font-medium text-purple-600">Opp</span>
                            <span class="font-semibold text-black text-sm"><?php echo e($match->oppTeam->emoji ?? ''); ?> <?php echo e($match->oppTeam->name ?? 'N/A'); ?></span>
                        </div>
                        <?php if($match->cgTeam): ?>
                            <div class="flex items-center justify-between">
                                <span class="text-xs font-medium text-green-600">CG</span>
                                <span class="font-semibold text-black text-sm"><?php echo e($match->cgTeam->emoji ?? ''); ?> <?php echo e($match->cgTeam->name ?? 'N/A'); ?></span>
                            </div>
                        <?php endif; ?>
                        <?php if($match->coTeam): ?>
                            <div class="flex items-center justify-between">
                                <span class="text-xs font-medium text-orange-600">CO</span>
                                <span class="font-semibold text-black text-sm"><?php echo e($match->coTeam->emoji ?? ''); ?> <?php echo e($match->coTeam->name ?? 'N/A'); ?></span>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-3 gap-2">
                    <button onclick="openScoreModal('<?php echo e(route('admin.ballots.create', $match->id)); ?>')"
                    ...
                    <a href="<?php echo e(route('admin.matches.edit', $match->id)); ?>"
                    ...
                    <form action="<?php echo e(route('admin.matches.destroy', $match->id)); ?>" method="POST" class="w-full"
                        ...
                        <tr class="hover:bg-slate-50">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-black">
                                    <?php echo e($match->round->tournament->name ?? 'N/A'); ?>

                                </div>
                                <div class="text-sm text-black"><?php echo e($match->round->name ?? 'N/A'); ?></div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-black"><?php echo e($match->room->name ?? 'TBA'); ?></div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="text-sm text-black">
                                    <div><span class="font-semibold text-blue-600">Gov:</span>
                                        <?php echo e($match->govTeam->emoji ?? ''); ?> <?php echo e($match->govTeam->name ?? 'N/A'); ?></div>
                                    <div><span class="font-semibold text-purple-600">Opp:</span>
                                        <?php echo e($match->oppTeam->emoji ?? ''); ?> <?php echo e($match->oppTeam->name ?? 'N/A'); ?></div>
                                    <?php if($match->cgTeam): ?>
                                        <div><span class="font-semibold text-green-600">CG:</span>
                                            <?php echo e($match->cgTeam->emoji ?? ''); ?> <?php echo e($match->cgTeam->name ?? 'N/A'); ?></div>
                                    <?php endif; ?>
                                    <?php if($match->coTeam): ?>
                                        <div><span class="font-semibold text-orange-600">CO:</span>
                                            <?php echo e($match->coTeam->emoji ?? ''); ?> <?php echo e($match->coTeam->name ?? 'N/A'); ?></div>
                                    <?php endif; ?>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-black"><?php echo e($match->adjudicator->name ?? 'TBA'); ?></div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span
                                    class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full <?php echo e(($match->result_status ?? '') === 'completed' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'); ?>">
                                    <?php echo e(ucfirst($match->result_status ?? 'Scheduled')); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center gap-2">
                                    ...
                                    <form action="<?php echo e(route('admin.matches.destroy', $match->id)); ?>" method="POST"
                                        class="inline-block"
                                    ...
                                    <div>
                                        ...
                                        <select id="auto_round_id" name="round_id" required
                                            ...
                                            <?php $__currentLoopData = $rounds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $round): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($round->id); ?>"><?php echo e($round->tournament->name); ?> -
                                                    <?php echo e($round->name); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\EDS-TABULATION\resources\views/admin/matches/index.blade.php ENDPATH**/ ?>