...
@section('content')
    ...
    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 mb-8">
        <div class="bg-white overflow-hidden rounded-xl shadow-sm ring-1 ring-slate-200 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-black">Total Tournaments</p>
                    <p class="text-2xl font-bold text-black">{{ $stats['total_tournaments'] }}</p>
                </div>
            </div>
        </div>
        <div class="bg-white overflow-hidden rounded-xl shadow-sm ring-1 ring-slate-200 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-black">{{ $stats['total_teams'] }}</p>
                </div>
            </div>
        </div>
        <div class="bg-white overflow-hidden rounded-xl shadow-sm ring-1 ring-slate-200 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-black">Total Adjudicators</p>
                    <p class="text-2xl font-bold text-black">{{ $stats['total_adjudicators'] }}</p>
                </div>
            </div>
        </div>
        <div class="bg-white overflow-hidden rounded-xl shadow-sm ring-1 ring-slate-200 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-black">Active Tournament</p>
                    <p class="text-2xl font-bold text-black">{{ $stats['active_tournament'] ? 'Yes' : 'No' }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="border-b border-slate-200 bg-slate-50 px-6 py-4 flex items-center justify-between">
        <h3 class="text-lg font-semibold text-black">🏆 Active Tournaments</h3>

    <a href="{{ route('admin.tournaments.create') }}"
        class="inline-flex items-center px-4 py-2 bg-indigo-600 text-black text-sm font-medium rounded-lg hover:bg-indigo-700 transition-colors">
    ...
    <div class="p-6">
                ...
                @foreach (\App\Models\Tournament::where('status', 'ongoing')->get() as $tournament)
                    <div class="flex items-center justify-between p-4 bg-slate-50 rounded-lg hover:bg-slate-100 transition-colors">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <h4 class="text-lg font-bold text-black">{{ $tournament->name }}</h4>
                        ...
                        <a href="{{ route('admin.tournaments.show', $tournament) }}"
                            class="inline-flex items-center px-4 py-2 bg-indigo-600 text-black text-sm font-semibold rounded-lg hover:bg-indigo-700 transition-colors">
                            Manage
        ...
        @else
            <div class="text-center py-12">
                ...
                <p class="text-black mb-4 text-lg">No ongoing tournaments</p>
                <a href="{{ route('admin.tournaments.create') }}"
    ...
    <div class="mt-8 bg-white overflow-hidden rounded-xl shadow-sm ring-1 ring-slate-200">
        <div class="border-b border-slate-200 bg-slate-50 px-6 py-4">
            <h3 class="text-lg font-semibold text-black">All Tournaments</h3>
        </div>
                        ...
                        <tr class="hover:bg-slate-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                ...
                                <a href="{{ route('admin.tournaments.edit', $tournament) }}"
                                    class="text-black hover:text-black">Edit</a>
                            </td>
                        </tr>
                    @empty
                        <tr>
