...
@section('content')
    <div class="max-w-2xl mx-auto">
        ...
        <form action="{{ route('admin.tournaments.store') }}" method="POST"
            ...
            <div class="space-y-6">
                <div>
                    <label for="name" class="block text-sm font-medium leading-6 text-slate-900">Tournament Name</label>
                    <div class="mt-2">
                ...
                <div>
                    <label for="format" class="block text-sm font-medium leading-6 text-slate-900">Format</label>
                    <div class="mt-2">
                ...
                <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-3">
                        <label for="start_date" class="block text-sm font-medium leading-6 text-slate-900">Start
                            Date</label>
                        <div class="mt-2">
                    ...
                    <div class="sm:col-span-3">
                        <label for="end_date" class="block text-sm font-medium leading-6 text-slate-900">End Date</label>
                        <div class="mt-2">
