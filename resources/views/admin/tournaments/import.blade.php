...
@section('content')
    ...
    <div id="data-summary" class="mb-8 bg-white rounded-xl shadow-sm ring-1 ring-slate-200 p-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
            <div class="text-center p-4 bg-blue-50 rounded-lg">
                <div id="count-teams" class="text-2xl font-bold text-blue-600">{{ $summary['teams'] }}</div>
                <div class="text-sm text-blue-800">Teams</div>
            </div>
            <div class="text-center p-4 bg-green-50 rounded-lg">
                <div id="count-speakers" class="text-2xl font-bold text-green-600">{{ $summary['speakers'] }}</div>
                <div class="text-sm text-green-800">Speakers</div>
            </div>
            <div class="text-center p-4 bg-purple-50 rounded-lg">
                <div id="count-adjudicators" class="text-2xl font-bold text-purple-600">{{ $summary['adjudicators'] }}</div>
                <div class="text-sm text-purple-800">Adjudicators</div>
            </div>
            <div class="text-center p-4 bg-amber-50 rounded-lg">
                <div id="count-rooms" class="text-2xl font-bold text-amber-600">{{ $summary['rooms'] }}</div>
                <div class="text-sm text-amber-800">Rooms</div>
            </div>
            <div class="text-center p-4 bg-orange-50 rounded-lg">
                <div id="count-rounds" class="text-2xl font-bold text-orange-600">{{ $summary['rounds'] }}</div>
    ...
    <script>
        ...
        const uploadUrl = "{{ route('admin.tournaments.processImport', $tournament) }}";
