        ...
        <form action="{{ route('admin.ballots.store', $match->id) }}" method="POST" class="space-y-8">
            ...
            @if($match->round->tournament->format === 'british')
                ...
                <div class="bg-white shadow-sm ring-1 ring-slate-200 rounded-xl p-6">
                    <h3 class="text-lg font-semibold text-black mb-4">Opening Government</h3>
            ...
            <div class="flex items-center justify-end gap-x-6">
                ...
                <button type="submit"
                    class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-black shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Submit
                    Ballot</button>
            </div>
        </form>
    </div>
