...
@section('content')
    ...
    <div class="mb-6 bg-white rounded-lg shadow-sm p-4">
        <form method="GET" action="{{ route('admin.teams.index') }}" class="flex items-center gap-4">
            ...
            @if($tournamentFilter)
                <a href="{{ route('admin.teams.index') }}" class="px-3 py-2 text-sm text-gray-600 hover:text-gray-900">
                    Clear Filter
                </a>
            @endif
        </form>
