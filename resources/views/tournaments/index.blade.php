            ...
            @forelse($tournaments ?? [] as $tournament)
                <div
                    ...
                    <div class="absolute top-4 right-4 z-10">
                        <span
                            class="inline-flex items-center px-3 py-1 text-xs font-pixel border-2 border-black shadow-pixel-sm transform rotate-2 {{ $tournament->status === 'ongoing' ? 'bg-green-400 text-black' : 'bg-slate-200 text-slate-600' }}">
